...
function Gdax (options) {
    ...
    Object.getOwnPropertyNames(Object.getPrototypeOf(privateClient)).forEach(prop => {
        if (typeof  privateClient[prop] === 'function' && prop !== 'constructor') {
            self[prop] = privateClient[prop];
        }
    });
...
Gdax.prototype.properties = {
    ...
    methods: {
        implemented: ["getRate", "getTicker", "getOrderBook", "getTrades", "getBalance"],
