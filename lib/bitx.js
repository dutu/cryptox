...
function Bitx (options) {
    ...
    self.getOrderBook = function (options, callback) {
        ...
        bitxPublic.getOrderBook(pair, function (err, bitxOrderBook) {
            ...
            // var jf = require("jsonfile"); jf.writeFileSync(__dirname + "/bitstamp-getTransactions_MockApiResponse-user_transactions.json", bitxOrderBook);     // only used to create MockApiResponse file for the test unit
    ...
    self.getBalance = function (options, callback) {
        ...
        bitxPrivate.getBalance(function (err, xBalance) {
            ...
            // var jf = require("jsonfile"); jf.writeFileSync(__dirname + "/bitstamp-getTransactions_MockApiResponse-user_transactions.json", xBalance);     // only used to create MockApiResponse file for the test unit
