...
Poloniex.prototype.properties = {
    ...
    methods: {
        notImplemented: ["getTrades", "getFee", "getTransactions", "getOpenOrders", "postSellOrder", "postBuyOrder", "cancelOrder", "getLendBook", "getActiveOffers", "postOffer", "cancelOffer"],
        notSupported: []
    },
