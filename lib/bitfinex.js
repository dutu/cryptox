...
function Bitfinex (options) {
    ...
    self.getBalance = function (options, callback) {
        ...
        bitfinexPrivate.wallet_balances(function (err, bitfinexBalance) {
            ...
            // var jf = require("jsonfile"); jf.writeFileSync(__dirname + "/bitstamp-getTransactions_MockApiResponse-user_transactions.json", bitfinexBalance);     // only used to create MockApiResponse file for the test unit
